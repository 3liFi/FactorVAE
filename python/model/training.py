...
from .vae import VAE, vae_loss as vae_loss_fc, DiscriminatorModel, LATENT_DIM, HyperParams
...
class EpochEndCallback(Callback):
    ...
    def on_train_epoch_end(self, trainer, pl_module):
        from sample import replicate_images
        import matplotlib

        self.gif_extractor.append_figure(
            replicate_images(self.gif_extractor.dataset, cast(VAELightning, pl_module), show=False, save=False))
